...
class FileClient:
    ...
    def show_otp_window(self, otp: str) -> None:
        ...
        def show_window():
            ...
            tk.Label(frame, text="This code will expire in 60 seconds", font=("Arial", 10)).pack()
    ...
    def share_file_with_server(self, filename: str, target_username: str, 
                             encrypted_key: str, signature: str, timestamp: str) -> Tuple[bool, str]:
        """Request file sharing from server"""
        # Verify signature
        ...
        self.log_action(self.username, "SHARE", f"Shared file {filename} with {target_username}")
